...
static void*
tsm_getptr_ifc_mrm_system_fault_level(struct tsm_simulink_input* simu_in) {
    return &(simu_in->rt_in_diag_tsm.ifc_mrm_system_fault_level);
}
...
static const struct tsm_test_signal ts_sig[] = {
    ...
    {
        .sig_type = TYPE_UINT8,
        .signal_name = "ifc_mrm_system_fault_level",
        .get_signal_ptr = tsm_getptr_ifc_mrm_system_fault_level,
    },
    {
        .sig_type = TYPE_UINT8,
